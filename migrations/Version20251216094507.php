...
final class Version20251216094507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN products_categories.product_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN products_categories.category_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE products_image (id UUID NOT NULL, products_id UUID DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, original_name VARCHAR(255) DEFAULT NULL, mime_type VARCHAR(255) DEFAULT NULL, tag VARCHAR(255) DEFAULT NULL, size INT DEFAULT NULL, dimensions JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
